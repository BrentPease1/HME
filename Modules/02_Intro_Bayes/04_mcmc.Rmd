...
This is a simplified depiction of what we do in Bayesian Analyses, but hopefully it helps understand the concept of learning about a probability distirbution via sampling.
...
# Simulate data
set.seed(277)
y <- rbinom(20,1,0.7)  # note truth here is 0.7 - probability of detecting, observing, surviving, etc. "give me 20 values of either 0 or 1, with 1 occurring with probability 0.7 and 0 occurring with probability 1-0.7 = 0.3.
...
for(i in 1:n.iters){
  ...
  keep_p[i] <- p #store all the keepers - this is our *chain*!
